...
export const ApiMessageCode = {
  ...
  INVENTORY_ADJUSTMENT_INVALID_DELTA: 'INVENTORY_ADJUSTMENT_INVALID_DELTA',
  INVENTORY_ADJUSTMENT_FORBIDDEN_NOT_MANAGER: 'INVENTORY_ADJUSTMENT_FORBIDDEN_NOT_MANAGER',
  PRODUCT_NOT_FOUND_FOR_ADJUSTMENT: 'PRODUCT_NOT_FOUND_FOR_ADJUSTMENT',
  ...
  SALE_VOID_FORBIDDEN_NOT_MANAGER: 'SALE_VOID_FORBIDDEN_NOT_MANAGER',
  ...
  // Subscription (Kasero Pro). PRO_REQUIRED, PULSE_FREE_LIMIT_REACHED and
  // AI_RECEIPT_FAILED are reserved for the Pro feature surfaces (Pulse
  // digest, receipt snap-to-expense) that gate on the same tier.
  SUBSCRIPTION_REDEEM_SUCCESS: 'SUBSCRIPTION_REDEEM_SUCCESS',
  SUBSCRIPTION_INVALID_CODE: 'SUBSCRIPTION_INVALID_CODE',
  SUBSCRIPTION_NOT_CONFIGURED: 'SUBSCRIPTION_NOT_CONFIGURED',
  SUBSCRIPTION_OWNER_ONLY: 'SUBSCRIPTION_OWNER_ONLY',
  PRO_REQUIRED: 'PRO_REQUIRED',
  PULSE_FREE_LIMIT_REACHED: 'PULSE_FREE_LIMIT_REACHED',
  AI_RECEIPT_FAILED: 'AI_RECEIPT_FAILED',
  AI_PULSE_FAILED: 'AI_PULSE_FAILED',
} as const
